...
(66,15,'','',NULL,0,NULL,'nashiru-muniru','https://prosfata.space/view/experts/nashiru-muniru',0,1,0.00,0),
...
(0,15,'','',NULL,0,NULL,'',NULL,0,0,0.00,0);
...
CREATE TABLE `expert_time_slots` (
  ...
  `created_at` timestamp NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1026 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
(15,'nmuniru@yahoo.com','',NULL,'$2a$10$erpni9CSNWQgcKPc9QKcAukeMkm8b.tjCxR2lS4jjNvtIHenuL9Uu','2026-01-08 14:59:39',2,0,NULL,1,NULL,'/uploads/profile_photos/1767957375965_ddai1120_1_.jpg','','','','active','2025-09-28 14:56:10','2026-01-10 04:08:41','Nashiru','Muniru',1,NULL,'',NULL,NULL,'nashiru-muniru',NULL,NULL,0,0,NULL,1),
...
-- Dump completed on 2026-01-10  4:12:54
